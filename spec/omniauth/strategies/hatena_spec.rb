...
describe OmniAuth::Strategies::Hatena do
  ...
  its('options.client_options.request_token_url') { should == 'https://www.hatena.ne.jp/oauth/initiate' }
  its('options.client_options.access_token_url') { should == 'https://www.hatena.ne.jp/oauth/token' }
